...
ResultSet rs;
    ...
    public ViewStat() {
     ...
     public void jTable1(){
        try{
        String sql = "select Earn, Cost, Month, Year, Profit, Loss from `monthly_stat` where Year=?";
    ...
    public void jTable2(){
        try{
        String sql = "select Yearly_Earn, Yearly_Cost, Year, Profit, Loss from `yearly_stat`";
        pst=conn.prepareStatement(sql);
        rs=pst.executeQuery();
